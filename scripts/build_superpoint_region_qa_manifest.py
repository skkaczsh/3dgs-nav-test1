...
def build_manifest(regions: list[dict[str, Any]], observations: list[dict[str, Any]], reviews: list[dict[str, Any]]) -> list[dict[str, Any]]:
...
def main() -> None:
    ...
    rows = build_manifest(read_jsonl(args.regions_jsonl), read_jsonl(args.observations_jsonl), read_jsonl(args.reviews_jsonl))
