...
VIEW_SURFACE_SPLAT_RADIUS="${VIEW_SURFACE_SPLAT_RADIUS:-1}"
...
VIEW_SURFACE_FILL_RADIUS="${VIEW_SURFACE_FILL_RADIUS:-3}"
...
VIEW_SURFACE_EXPAND_BLOCK_UPPER_RATIO="${VIEW_SURFACE_EXPAND_BLOCK_UPPER_RATIO:-0.18}"
VIEW_SURFACE_EXPAND_SKY_BLUE_GUARD="${VIEW_SURFACE_EXPAND_SKY_BLUE_GUARD:-1}"
...
main() {
  ...
  geometry_extra_args=()
  if [[ "${VIEW_SURFACE_EXPAND_SKY_BLUE_GUARD}" == "0" ]]; then
