...
VIEW_SURFACE_FAR_DEPTH_START="${VIEW_SURFACE_FAR_DEPTH_START:-18.0}"
VIEW_SURFACE_FAR_SPLAT_RADIUS="${VIEW_SURFACE_FAR_SPLAT_RADIUS:-2}"
VIEW_SURFACE_FAR_SPLAT_COLOR_LAB_THRESHOLD="${VIEW_SURFACE_FAR_SPLAT_COLOR_LAB_THRESHOLD:-24.0}"
...
VIEW_SURFACE_FAR_FILL_RADIUS="${VIEW_SURFACE_FAR_FILL_RADIUS:-5}"
VIEW_SURFACE_FAR_FILL_DEPTH_RANGE="${VIEW_SURFACE_FAR_FILL_DEPTH_RANGE:-0.25}"
