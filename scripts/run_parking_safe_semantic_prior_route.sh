...
VIEW_SURFACE_SPLAT_RADIUS="${VIEW_SURFACE_SPLAT_RADIUS:-0}"
VIEW_SURFACE_SPLAT_COLOR_LAB_THRESHOLD="${VIEW_SURFACE_SPLAT_COLOR_LAB_THRESHOLD:-18.0}"
VIEW_SURFACE_FAR_DEPTH_START="${VIEW_SURFACE_FAR_DEPTH_START:-0.0}"
VIEW_SURFACE_FAR_SPLAT_RADIUS="${VIEW_SURFACE_FAR_SPLAT_RADIUS:-1}"
VIEW_SURFACE_FAR_SPLAT_COLOR_LAB_THRESHOLD="${VIEW_SURFACE_FAR_SPLAT_COLOR_LAB_THRESHOLD:-18.0}"
VIEW_SURFACE_FILL_RADIUS="${VIEW_SURFACE_FILL_RADIUS:-0}"
VIEW_SURFACE_FILL_DEPTH_RANGE="${VIEW_SURFACE_FILL_DEPTH_RANGE:-0.10}"
VIEW_SURFACE_FILL_MIN_NEIGHBORS="${VIEW_SURFACE_FILL_MIN_NEIGHBORS:-6}"
VIEW_SURFACE_FAR_FILL_RADIUS="${VIEW_SURFACE_FAR_FILL_RADIUS:-0}"
VIEW_SURFACE_FAR_FILL_DEPTH_RANGE="${VIEW_SURFACE_FAR_FILL_DEPTH_RANGE:-0.10}"
VIEW_SURFACE_FAR_FILL_MIN_NEIGHBORS="${VIEW_SURFACE_FAR_FILL_MIN_NEIGHBORS:-8}"
VIEW_SURFACE_EXPAND_BLOCK_UPPER_RATIO="${VIEW_SURFACE_EXPAND_BLOCK_UPPER_RATIO:-0.0}"
VIEW_SURFACE_EXPAND_SKY_BLUE_GUARD="${VIEW_SURFACE_EXPAND_SKY_BLUE_GUARD:-0}"
...
main() {
  ...
  echo "view_surface_splat=radius:${VIEW_SURFACE_SPLAT_RADIUS} color_lab:${VIEW_SURFACE_SPLAT_COLOR_LAB_THRESHOLD}"
  echo "view_surface_far_splat=start:${VIEW_SURFACE_FAR_DEPTH_START} radius:${VIEW_SURFACE_FAR_SPLAT_RADIUS} color_lab:${VIEW_SURFACE_FAR_SPLAT_COLOR_LAB_THRESHOLD}"
  echo "view_surface_fill=radius:${VIEW_SURFACE_FILL_RADIUS} range:${VIEW_SURFACE_FILL_DEPTH_RANGE} min_neighbors:${VIEW_SURFACE_FILL_MIN_NEIGHBORS}"
  echo "view_surface_far_fill=radius:${VIEW_SURFACE_FAR_FILL_RADIUS} range:${VIEW_SURFACE_FAR_FILL_DEPTH_RANGE} min_neighbors:${VIEW_SURFACE_FAR_FILL_MIN_NEIGHBORS}"
  echo "view_surface_expand_guard=upper_ratio:${VIEW_SURFACE_EXPAND_BLOCK_UPPER_RATIO} sky_blue:${VIEW_SURFACE_EXPAND_SKY_BLUE_GUARD}"
  ...
  geometry_extra_args=()
  if [[ "${VIEW_SURFACE_EXPAND_SKY_BLUE_GUARD}" == "1" ]]; then
    geometry_extra_args+=(--view-surface-expand-sky-blue-guard)
  else
    geometry_extra_args+=(--no-view-surface-expand-sky-blue-guard)
  fi
  ...
  run_cmd "${PYTHON}" scripts/build_geometry_guidance_maps.py \
    ...
    --view-surface-splat-radius "${VIEW_SURFACE_SPLAT_RADIUS}" \
    --view-surface-splat-color-lab-threshold "${VIEW_SURFACE_SPLAT_COLOR_LAB_THRESHOLD}" \
    --view-surface-far-depth-start "${VIEW_SURFACE_FAR_DEPTH_START}" \
    --view-surface-far-splat-radius "${VIEW_SURFACE_FAR_SPLAT_RADIUS}" \
    --view-surface-far-splat-color-lab-threshold "${VIEW_SURFACE_FAR_SPLAT_COLOR_LAB_THRESHOLD}" \
    --view-surface-fill-radius "${VIEW_SURFACE_FILL_RADIUS}" \
    --view-surface-fill-depth-range "${VIEW_SURFACE_FILL_DEPTH_RANGE}" \
    --view-surface-fill-min-neighbors "${VIEW_SURFACE_FILL_MIN_NEIGHBORS}" \
    --view-surface-far-fill-radius "${VIEW_SURFACE_FAR_FILL_RADIUS}" \
    --view-surface-far-fill-depth-range "${VIEW_SURFACE_FAR_FILL_DEPTH_RANGE}" \
    --view-surface-far-fill-min-neighbors "${VIEW_SURFACE_FAR_FILL_MIN_NEIGHBORS}" \
    --view-surface-expand-block-upper-ratio "${VIEW_SURFACE_EXPAND_BLOCK_UPPER_RATIO}" \
