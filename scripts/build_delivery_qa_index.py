...
def render_markdown(package_dir: Path, package: dict[str, Any], validation: dict[str, Any]) -> str:
    ...
    for role in [
        ...
        "visual_acceptance_review_html",
        "visual_acceptance_review_validation",
        "next_increment_readiness_markdown",
...
def render_html(package_dir: Path, package: dict[str, Any], validation: dict[str, Any]) -> str:
    ...
    report_items = [
        ...
        ("Visual acceptance HTML", row_link(package_dir, role_map, "visual_acceptance_review_html")),
        ("Visual acceptance validation", row_link(package_dir, role_map, "visual_acceptance_review_validation")),
        ("Next increment readiness", row_link(package_dir, role_map, "next_increment_readiness_markdown")),
        ("Next increment readiness JSON", row_link(package_dir, role_map, "next_increment_readiness")),
    ...
    metric_rows = [
        ...
        ("Next increment status", metrics.get("next_increment_status")),
