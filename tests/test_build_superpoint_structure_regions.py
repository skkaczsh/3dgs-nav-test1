...
def test_only_same_high_confidence_label_can_form_region() -> None:
    posteriors = [
        {"object_id": 1, "propagation_eligible": True, "structural_candidate_label": "floor"},
        {"object_id": 2, "propagation_eligible": True, "structural_candidate_label": "floor"},
        {"object_id": 3, "propagation_eligible": True, "structural_candidate_label": "wall"},
    ]
    edges = [
