...
def test_manifest_uses_anchor_evidence_and_prioritizes_sparse_support() -> None:
    regions = [
        {"region_id": "region:wall:0", "region_label": "wall", "superpoint_count": 16, "max_hops": 2, "source_anchor_ids": [1]},
        {"region_id": "region:floor:1", "region_label": "floor", "superpoint_count": 16, "max_hops": 2, "source_anchor_ids": [2, 3]},
    ]
    ...
    rows = build_manifest(regions, observations, reviews)
